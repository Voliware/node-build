...
/**
 * Abstract class to build and output building information.
 * If the input is a directory or regexp, it will use glob to find files.
 * The method "build" must be implemented.
 */
class Builder {
     ...
     * Note paths with dots like "/path/to.file/app.min.js" are not supported.
     */
    ...
    /**
     * Empty all files in the output directory
     */
    emptyOutputDirectory(){
        ...
        try {
            ...
            for (const file of files) {
                ...
                if(Fs.lstatSync(fullpath).isFile(fullpath)){
